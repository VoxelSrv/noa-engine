...
function sweep_impl(getVoxel, getColision, callback, vec, base, max, epsilon, colisionBox) {
...
function sweep(getVoxel, getColision, box, dir, callback, noTranslate, epsilon) {
    ...
    var dist = sweep_impl(getVoxel, getColision, callback, vec, base, max, epsilon, box)
