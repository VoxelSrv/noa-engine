...
module.exports = function (opts, testSolid, testFluid, colision) {
    return new Physics(opts, testSolid, testFluid, colision)
}
...
*/
function Physics(opts, testSolid, testFluid, getColision) {
...
function processCollisions(self, box, velocity, resting) {
    ...
    return sweep(self.testSolid, self.getColision, box, velocity, function (dist, axis, dir, vec) {
        resting[axis] = dir
         vec[axis] = 0
    })
}
...
function tryAutoStepping(self, b, oldBox, dx) {
    ...
    sweep(getVoxels, self.getColision, oldBox, dx, function (dist, axis, dir, vec) {
    ...
    sweep(getVoxels, self.getColision, oldBox, upvec, function (dist, axis, dir, vec) {
        collided = true
        return true
    })
...
function bodyAsleep(self, body, dt, noGravity) {
    ...
    sweep(self.testSolid, self.getColision, body.aabb, sleepVec, function () {
        isResting = true
        return true
    }, true)
    return isResting
