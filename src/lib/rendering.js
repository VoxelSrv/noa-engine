...
Rendering.prototype.getEngine = function () {
	return this._engine;
};

Rendering.prototype.addScene = function (scene) {
	this._multiscenes.push(scene);
};

Rendering.prototype.getSceneArray = function (scene) {
	return this._multiscenes;
};
...
Rendering.prototype.addMeshToScene = function (mesh, isStatic, pos, _containingChunk) {
	...
	if (isStatic) {
		var chunk = _containingChunk || this.noa.world._getChunkByCoords(pos[0], pos[1], pos[2]);
...
var profile_hook = PROFILE ? makeProfileHook(200, 'render internals') : () => {};
